function generateHTML(teamArray){
    ...
    teamArray.forEach(member => {
            ...
            <div class="container-md d-flex justify-content-center" id= "manager">
                <div class="card">
                    <div class="card-header" id= "managerHeader">
                        ...
                        <h3 class = "card-subtitle mb-2 text-muted">${member.role}</h3>
                    </div>
                    <div class="card-body">
        ...
        if(member.role == 'Engineer'){
            ...
            <div class="col mt-3" id = "engineer">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="mailto:${member.email}" class="card-link emailLink">Email: ${member.email}</a>
                        <div class = "mt-3">
                            <a href="#" class="btn btn-primary buttonFormat" target="_blank">GitHub Profile</a>
                        </div>             
                    </div>
                </div>
            </div>`;
